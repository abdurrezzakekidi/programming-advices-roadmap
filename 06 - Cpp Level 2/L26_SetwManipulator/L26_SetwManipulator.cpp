...
void RoadmapProgress()
{
	...
	cout << left << setw(15) << "C-01" << "|" << setw(50) << "Basics of Programming 1" << "|" << setw(14) << "%100" << "|" << endl;
	cout << left << setw(15) << "C-02" << "|" << setw(50) << "Algoritms & Problem Solving 1" << "|" << setw(14) << "%100" << "|" << endl;
	cout << left << setw(15) << "C-03" << "|" << setw(50) << "Programming using C++ 1" << "|" << setw(14) << "%100" << "|" << endl;
	cout << left << setw(15) << "C-04" << "|" << setw(50) << "Algoritms & Problem Solving 1 Advanced Solutions" << "|" << setw(14) << "%100" << "|" << endl;
	cout << left << setw(15) << "C-05" << "|" << setw(50) << "Algoritms & Problem Solving 2" << "|" << setw(14) << "%100" << "|" << endl;
	cout << left << setw(15) << "C-06" << "|" << setw(50) << "Introduction to programming using C++ 2" << "|" << setw(14) << "%44" << "|" << endl;
