...
public:
	...
	) : clsEmployee(id, firstName, lastName, email, phoneNumber, title, department, salary) // Call the base class constructor to initialize common attributes
	{
		_mainProgrammingLanguage = mainProgrammingLanguage;
	}
	// Getter and setter for main programming language
	...
	// Override the print function to include developer-specific information
	...
	void print()
	{
		...
		cout << "\nPLanguage     :" << getMainProgrammingLanguage();
		cout << "\n--------------------------------------------\n";
...
int main()
{
	...
	//developer1.SendEmail("Welcome to the team!", "Dear " + developer1.getFirstName() + ",\n\nWelcome to our software development team!");
