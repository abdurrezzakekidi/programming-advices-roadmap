...
{
    eQuick_kWithdraw = 1, eNormal_Withdraw = 2, eDeposit= 3,
    eCheck_Balance = 4, eLogout = 5, 
};
...
void PerfromMainMenueOption(enMainMenueOptions MainMenueOption)
{
    ...
    {
    case enMainMenueOptions::eQuick_kWithdraw:
        {
        system("cls"); 
        ShowQuickWithdrawScreen(); 
        GoBackToMainMenue();
    ...
    case enMainMenueOptions::eNormal_Withdraw:
        system("cls"); 
        ShowNormalWithDrawScreen(); 
        GoBackToMainMenue();
        break;
    ...
    case enMainMenueOptions::eCheck_Balance:
        system("cls");   
